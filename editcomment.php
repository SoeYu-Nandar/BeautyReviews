...
<body>
    ...
    <div class="card-footer">
        ...
        <h3><p class="text-center text-body-tertiary">Editing Comment</p></h3>
            ...
            echo "<form method='post' action ='".editComments($conn)."'> 
                            ...
                            <textarea class='form-control' name='message' cols='200' row='80'>" .$message . "</textarea>
                                ...
                                <p class='text-end'><button type='submit' name='editSubmit' class='btn btn-primary mt-2 me-2'>Edit
